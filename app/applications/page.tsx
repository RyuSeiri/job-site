...
export default function ApplicationsPage() {
  ...
  const filteredApplications = applications.filter((app) => {
    ...
    if (activeTab === "active")
      return ["pending", "interview", "passed"].includes(app.statusType);
                  ...
                  <p className="text-2xl font-bold text-yellow-600">
                    {
                      applications.filter((app) =>
                        ["pending", "interview"].includes(app.statusType)
                      ).length
                    }
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">
                    {
                      applications.filter((app) => app.statusType === "passed")
                        .length
                    }
                  </p>
                </div>
            ...
            >
              <TabsList className="grid w-full grid-cols-3">
                ...
                <TabsTrigger value="active">
                  ...
                  {
                    applications.filter((app) =>
                      ["pending", "interview", "passed"].includes(
                        app.statusType
                      )
                    ).length
                  }
                ...
                <TabsTrigger value="completed">
                  完了 (
                  {
                    applications.filter((app) => app.statusType === "rejected")
                      .length
                  }
                  )
                </TabsTrigger>
